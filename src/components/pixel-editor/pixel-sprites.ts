...
export const SPRITES: Record<string, SpriteData> = {
  chair: createSprite([
    ...
    seg(3,['darkBrown','brown',...rep('cream',20),'brown','darkBrown'],3),
    seg(3,['darkBrown','brown',...rep('peach',20),'cream','brown','darkBrown'],3),
    seg(3,['darkBrown','brown','cream',...rep('peach',18),'cream','brown','darkBrown'],3),
  ...
  table_square: createSprite([
    ...
    seg(4,['darkBrown','brown',...rep('lightBrown',20),'brown','darkBrown'],4),
    seg(3,['darkBrown','brown','lightBrown',...rep('cream',20),'lightBrown','brown','darkBrown'],3),
    seg(2,['darkBrown','brown','lightBrown',...rep('cream',22),'lightBrown','brown','darkBrown'],2),
    seg(2,['darkBrown','brown','lightBrown',...rep('cream',22),'lightBrown','brown','darkBrown'],2),
    seg(3,['darkBrown','brown','lightBrown',...rep('cream',20),'lightBrown','brown','darkBrown'],3),
    seg(4,['darkBrown','brown',...rep('lightBrown',20),'brown','darkBrown'],4),
    seg(6,[...rep('darkBrown',20)],6),
  ...
  table_round: createSprite([
    ...
    seg(6,['darkBrown','brown',...rep('lightBrown',16),'brown','darkBrown'],6),
    seg(4,['darkBrown','brown','lightBrown',...rep('cream',18),'lightBrown','brown'],4),
    seg(3,['darkBrown','brown',...rep('cream',22),'brown','darkBrown'],3),
    seg(3,['darkBrown','brown',...rep('cream',22),'brown','darkBrown'],3),
    seg(4,['darkBrown','brown','lightBrown',...rep('cream',18),'lightBrown','brown'],4),
    seg(6,['darkBrown','brown',...rep('lightBrown',16),'brown','darkBrown'],6),
    seg(9,[...rep('darkBrown',14)],9),
  ...
  counter: createSprite([
    ...Array(4).fill(new Array(SPRITE_SIZE).fill(0)),
    seg(4,[...rep('darkBrown',24)],4),
    seg(3,['darkBrown','brown',...rep('golden',22),'brown','darkBrown'],3),
    seg(3,['darkBrown','brown','golden',...rep('cream',20),'golden','brown','darkBrown'],3),
    seg(3,['darkBrown','brown',...rep('golden',22),'brown','darkBrown'],3),
    seg(4,[...rep('darkBrown',24)],4),
  ...
  stool: createSprite([
    ...
    seg(8,['darkGray','midGray',...rep('silver',11),'midGray','darkGray'],8),
    seg(8,['darkGray','midGray',...rep('silver',11),'midGray','darkGray'],8),
    seg(9,[...rep('darkGray',14)],9),
  ...
  partition: createSprite([
    ...Array(2).fill(new Array(SPRITE_SIZE).fill(0)),
    seg(2,[...rep('darkBrown',28)],2),
    seg(2,['darkBrown',...rep('cream',26),'darkBrown'],2),
    seg(2,['darkBrown',...rep('cream',26),'darkBrown'],2),
    seg(2,['darkBrown',...rep('cream',26),'darkBrown'],2),
    seg(2,['darkBrown',...rep('cream',26),'darkBrown'],2),
    seg(2,['darkBrown',...rep('cream',26),'darkBrown'],2),
