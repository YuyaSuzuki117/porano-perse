  ...
  switch (name) {
    case 'japanese':
      return {
        ...
        baseboardClearcoat: 0.2875, baseboardClearcoatRoughness: 0.25,
        crownClearcoat: 0.2875, crownClearcoatRoughness: 0.25, envMapIntensity: 1.44,
      };
    case 'luxury':
      return {
        ...
        baseboardClearcoat: 0.46, baseboardClearcoatRoughness: 0.2,
        crownClearcoat: 0.46, crownClearcoatRoughness: 0.2, envMapIntensity: 2.16,
      };
    case 'retro':
      return {
    ...
    case 'industrial':
      return {
        ...
        crownClearcoat: 0.23, crownClearcoatRoughness: 0.3, envMapIntensity: 1.44,
      };
    case 'minimal':
      return {
        ...
        skipBaseboard: false, skipCrown: false, doubleCrown: false, pipeCrown: false,
        baseboardClearcoat: 0.1725, baseboardClearcoatRoughness: 0.3,
        crownClearcoat: 0.1725, crownClearcoatRoughness: 0.3, envMapIntensity: 1.44,
      };
    case 'modern':
      return {
        baseboardHeight: 0.06, baseboardDepth: 0.01, baseboardColor: style.wallColor,
    ...
    default: // medical等
      return {
        ...
        skipBaseboard: false, skipCrown: false, doubleCrown: false, pipeCrown: false,
        baseboardClearcoat: 0.15, baseboardClearcoatRoughness: 0.3,
        crownClearcoat: 0.15, crownClearcoatRoughness: 0.3, envMapIntensity: 1.44,
      };
  }
}
        ...
        for (let si = 0; si < segments.length; si++) {
          ...
          elements.push(
            ...
            >
              ...
              <meshPhysicalMaterial color={profile.baseboardColor} roughness={0.6} clearcoat={profile.baseboardClearcoat} clearcoatRoughness={profile.baseboardClearcoatRoughness} envMapIntensity={profile.envMapIntensity} specularIntensity={0.4} />
            </mesh>
          );
        }
      }
        ...
        if (profile.doubleCrown) {
          ...
          elements.push(
            ...
            >
              ...
              <meshPhysicalMaterial color={profile.crownColor} roughness={0.3} clearcoat={profile.crownClearcoat} clearcoatRoughness={profile.crownClearcoatRoughness} envMapIntensity={profile.envMapIntensity} specularIntensity={0.4} />
            </mesh>
          );
          elements.push(
            <mesh
          ...
          elements.push(
            ...
            >
              ...
              <meshPhysicalMaterial color={profile.crownColor} roughness={0.15} metalness={0.85} clearcoat={profile.crownClearcoat} clearcoatRoughness={profile.crownClearcoatRoughness} specularIntensity={0.4} />
            </mesh>
          );
        } else {
          // 標準クラウン
          elements.push(
            ...
            >
              ...
              <meshPhysicalMaterial color={profile.crownColor} roughness={0.5} clearcoat={profile.crownClearcoat} clearcoatRoughness={profile.crownClearcoatRoughness} envMapIntensity={profile.envMapIntensity} specularIntensity={0.4} />
            </mesh>
          );
        }
      }
