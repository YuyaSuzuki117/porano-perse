...
MODELS = [
    "chair", "sofa", "armchair", "table_square", "table_round",
    "stool", "bar_stool", "booth_sofa", "desk", "bed_double",
    "bookcase", "shelf", "counter"
]
...
for name in MODELS:
    ...
    print(f"[OK] {name}: W{w:.3f} H{h:.3f} D{d:.3f} verts={verts} objs={len(objects)}")
