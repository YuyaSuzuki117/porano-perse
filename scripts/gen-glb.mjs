...
const furniture = {
  chair: () => {
    const parts = [
      ...
      // 座面前後エッジ（丸み表現）
      { ...merge([cyl(0.013, 0.013, 0.40, 12, 0, 0.455, 0.20), cyl(0.013, 0.013, 0.40, 12, 0, 0.455, -0.20)]), color: W, name: 'seat_edges_fb' },
      // 座面左右エッジ
      { ...merge([cyl(0.013, 0.013, 0.36, 12, -0.21, 0.455, 0), cyl(0.013, 0.013, 0.36, 12, 0.21, 0.455, 0)]), color: W, name: 'seat_edges_lr' },
      // クッション本体（沈み込み表現: 外周高め + 中央凹み）
      { ...box(0.36, 0.030, 0.34, 0, 0.485, 0.01), color: FR, name: 'cushion_base', roughness: 0.85 },
      { ...box(0.30, 0.015, 0.28, 0, 0.505, 0.01), color: FR, name: 'cushion_top', roughness: 0.90 },
      // クッションステッチライン（十字）
      { ...merge([box(0.34, 0.032, 0.004, 0, 0.486, 0.01), box(0.004, 0.032, 0.32, 0, 0.486, 0.01)]), color: [0.65, 0.22, 0.22], name: 'cushion_stitch' },
      // 背もたれ（5段分割でより滑らかな曲線）
      { ...box(0.38, 0.08, 0.022, 0, 0.535, -0.182), color: W, name: 'back_1' },
      { ...box(0.38, 0.08, 0.021, 0, 0.615, -0.186), color: W, name: 'back_2' },
      { ...box(0.38, 0.08, 0.020, 0, 0.695, -0.190), color: W, name: 'back_3' },
      { ...box(0.37, 0.08, 0.019, 0, 0.775, -0.194), color: W, name: 'back_4' },
      { ...box(0.36, 0.06, 0.018, 0, 0.845, -0.198), color: W, name: 'back_5' },
      // 背もたれ上部フレーム（笠木）
      { ...merge([cyl(0.015, 0.015, 0.38, 12, 0, 0.88, -0.198)]), color: WD, name: 'back_top_rail' },
      // 背もたれクッション
      { ...box(0.30, 0.26, 0.012, 0, 0.70, -0.168), color: FR, name: 'back_cushion', roughness: 0.85 },
      // 脚4本（テーパー付き円柱、分割数16で滑らか）
      { ...merge([cyl(0.014, 0.020, 0.44, 14, -0.18, 0.22, -0.17)]), color: WD, name: 'leg_bl' },
      { ...merge([cyl(0.014, 0.020, 0.44, 14, 0.18, 0.22, -0.17)]), color: WD, name: 'leg_br' },
      { ...merge([cyl(0.014, 0.020, 0.44, 14, -0.18, 0.22, 0.17)]), color: WD, name: 'leg_fl' },
      { ...merge([cyl(0.014, 0.020, 0.44, 14, 0.18, 0.22, 0.17)]), color: WD, name: 'leg_fr' },
      // 脚接合リング（座面と脚の繋ぎ目）
      { ...merge([cyl(0.020, 0.020, 0.015, 12, -0.18, 0.445, -0.17), cyl(0.020, 0.020, 0.015, 12, 0.18, 0.445, -0.17), cyl(0.020, 0.020, 0.015, 12, -0.18, 0.445, 0.17), cyl(0.020, 0.020, 0.015, 12, 0.18, 0.445, 0.17)]), color: WD, name: 'leg_joints' },
      // 横桟（前後左右）
      { ...merge([cyl(0.010, 0.010, 0.32, 8, 0, 0.12, -0.17), cyl(0.010, 0.010, 0.32, 8, 0, 0.12, 0.17)]), color: WD, name: 'stretchers_fb' },
      { ...merge([cyl(0.010, 0.010, 0.30, 8, -0.18, 0.12, 0), cyl(0.010, 0.010, 0.30, 8, 0.18, 0.12, 0)]), color: WD, name: 'stretchers_lr' },
    ];
